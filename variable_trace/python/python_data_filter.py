...
def main():
    ...
    data_path = os.path.join(python_data_path, f'python_final_trace_added.json')
    ...
    save_json(final_data_list, os.path.join(python_data_path, f'python_final_trace_added_choose_1.json'))
