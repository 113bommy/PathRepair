...
def check_actual_output(args):
    ...
    script_file_path = f"./python_test_code/python_test_{single_data['pid']}_{single_data['code_index']}.py"
    ...
    try:
        ...
        with open(f'./python_error/error_test.txt', "w", encoding='utf-8') as err_log_file:
...
if __name__ == "__main__":
    data_path = './data/python_test_final_adjustment.jsonl'
    ...
    save_dict_list_to_jsonl(final_result, './data/python_output_added_test.jsonl')
